...
// 数学関数の例
{
    ...
    Lib.print("\n");
    // ルート（非負の平方根） を返す関数 Math.sqrt
    // √2
    Lib.print("Math.sqrt(2)");
    Lib.print("   >>   ");
    Lib.print(Math.sqrt(2));
    Lib.print("\n");
    // √(-2) を得ようとすると結果は NaN になる（2乗して-2になる実数は存在しない）
    Lib.print("Math.sqrt(-2)");
    Lib.print("   >>   ");
    Lib.print(Math.sqrt(-2));
    Lib.print("\n");
    ...
    Lib.print(Math.ceil(-3.14));
    Lib.print("\n");
    // （発展） 三角関数 Math.sin, Math.cos, Math.tan と，円周率を表す名前 Math.PI
    Lib.print("Math.PI");
    Lib.print("   >>   ");
    Lib.print(Math.PI);
    Lib.print("\n");
    ...
    Lib.print(Math.tan(Math.PI / 4));
    Lib.print("\n");
    // （発展） 対数関数 Math.log と，自然対数の底 e を表す名前 Math.E
    Lib.print("Math.E");
    Lib.print("   >>   ");
    Lib.print(Math.E);
    Lib.print("\n");
